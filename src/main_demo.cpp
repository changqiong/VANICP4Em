...
int main(int argc, char *argv[]){
    ...
    std::string base_dir = "/home/changqiong/icpcuda/data/bunny/";
    std::string file_name = base_dir + "source.txt";
    ...
    save_pcl(base_dir + "airplane_0001_rotated.txt", B);

    /******** Calculate ICP ***********/
    start = GetTickCount();
    //icp_result = icp(B, A, 50,  1e-3);
    end = GetTickCount();
    ...
    save_pcl(base_dir + "airplane_0001_recovered.txt",D);
